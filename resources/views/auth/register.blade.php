            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="referred_by" class="col-md-4 col-form-label text-md-right">{{ __('Referral Code') }}</label>

                            <div class="col-md-6">
                                <input id="referred_by" type="text" class="form-control @error('referred_by') is-invalid @enderror" name="referred_by" value="{{ old('referred_by') }}" autocomplete="name" autofocus>
